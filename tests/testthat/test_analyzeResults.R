...
adf <- example_wide_data[,
  !colnames(example_wide_data) %in% example_wide_design$sample
]
...
test_that("calculateSummarizedCorrelationVector_Spearman", {
  ...
  expected_out <- read.csv(
    system.file(
      package = "NormalyzerDE",
      "testdata",
      "calculateSummarizedCorrelationVector_spearman.csv"
    ),
    check.names = FALSE
  )
...
test_that("calculateSummarizedCorrelationVector_Pearson", {
  ...
  expected_out <- read.csv(
    system.file(
      package = "NormalyzerDE",
      "testdata",
      "calculateSummarizedCorrelationVector_pearson.csv"
    ),
    check.names = FALSE
  )
...
test_that("calculateANOVAPValues", {
  ...
  expected_out <- read.csv(
    system.file(package = "NormalyzerDE", "testdata", "anova.csv"),
    check.names = FALSE
  )
