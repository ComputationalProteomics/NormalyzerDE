...
#> [1] "Writing 100 annotated rows to /tmp/Rtmp1Vj4ki/my_jobname/my_jobname_stats.tsv"
#> [1] "Writing statistics report"
#> [1] "All done! Results are stored in: /tmp/Rtmp1Vj4ki/my_jobname, processing time was 0 minutes"
```
