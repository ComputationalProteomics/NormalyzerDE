...
run_review_data_test <- function(super_dirname,
    ...
    roc_list[["roc_plot_normal_04cut"]] <- generate_roc_plot(normal_run_entries, rt_run_entries, only_normal=F, y_cutoff=0.4, title=gsub(".*\\/", "", output_base))
    roc_list[["roc_plot_normal_06cut"]] <- generate_roc_plot(normal_run_entries, rt_run_entries, only_normal=F, y_cutoff=0.6, title=gsub(".*\\/", "", output_base))
    roc_list[["roc_plot_normal_08cut"]] <- generate_roc_plot(normal_run_entries, rt_run_entries, only_normal=F, y_cutoff=0.8, title=gsub(".*\\/", "", output_base))
    roc_list[["roc_plot_all"]] <- generate_roc_plot(normal_run_entries, rt_run_entries, only_normal=F, title=gsub(".*\\/", "", output_base))
