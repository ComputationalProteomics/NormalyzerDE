...
setGeneric("jobName", function(object) {
  standardGeneric("jobName")
})
setMethod("jobName", signature(object = "NormalyzerDataset"), function(object) {
  slot(object, "jobName")
})
...
setMethod("rawData", signature(object = "NormalyzerDataset"), function(object) {
  slot(object, "rawData")
})

setGeneric("sampleNameCol", function(object) {
  standardGeneric("sampleNameCol")
})
setMethod(
  "sampleNameCol",
  signature(object = "NormalyzerDataset"),
  function(object) {
    slot(object, "sampleNameCol")
  }
)

setGeneric("groupNameCol", function(object) {
  standardGeneric("groupNameCol")
})
setMethod(
  "groupNameCol",
  signature(object = "NormalyzerDataset"),
  function(object) {
    slot(object, "groupNameCol")
  }
)

setGeneric("designMatrix", function(object) {
...
setMethod(
  ...
  signature(object = "NormalyzerDataset"),
  function(object) {
    slot(object, "sampleNames")
  }
)

setGeneric("filterrawdata", function(object) {
  standardGeneric("filterrawdata")
})
setMethod(
  "filterrawdata",
  signature(object = "NormalyzerDataset"),
  function(object) {
    slot(object, "filterrawdata")
  }
)

setGeneric("sampleReplicateGroups", function(object) {
  standardGeneric("sampleReplicateGroups")
})
setMethod(
  "sampleReplicateGroups",
  signature(object = "NormalyzerDataset"),
  function(object) {
    slot(object, "sampleReplicateGroups")
  }
)

setGeneric("samplesGroupsWithReplicates", function(object) {
  standardGeneric("samplesGroupsWithReplicates")
})
setMethod(
  "samplesGroupsWithReplicates",
  signature(object = "NormalyzerDataset"),
  function(object) {
    slot(object, "samplesGroupsWithReplicates")
  }
)

setGeneric("annotationValues", function(object) {
...
setMethod(
  ...
  signature(object = "NormalyzerDataset"),
  function(object) {
    slot(object, "annotationValues")
  }
)

setGeneric("retentionTimes", function(object) {
  standardGeneric("retentionTimes")
})
setMethod(
  "retentionTimes",
  signature(object = "NormalyzerDataset"),
  function(object) {
    slot(object, "retentionTimes")
  }
)
setGeneric("retentionTimes<-", function(object, value) {
  standardGeneric("retentionTimes<-")
})
setReplaceMethod(
  "retentionTimes",
...
setGeneric("isTinyRun", function(object) {
  standardGeneric("isTinyRun")
})
setMethod(
  "isTinyRun",
  signature(object = "NormalyzerDataset"),
  function(object) {
    slot(object, "isTinyRun")
  }
)

setGeneric("singleReplicateRun", function(object) {
  standardGeneric("singleReplicateRun")
})
setMethod(
  "singleReplicateRun",
  signature(object = "NormalyzerDataset"),
  function(object) {
    slot(object, "singleReplicateRun")
  }
)
setGeneric("singleReplicateRun<-", function(object, value) {
  standardGeneric("singleReplicateRun<-")
})
setReplaceMethod(
  "singleReplicateRun",
...
#' @keywords internal
setGeneric(name = "detectSingleReplicate", function(nds, quiet) {
  standardGeneric("detectSingleReplicate")
})

#' @rdname detectSingleReplicate
setMethod(
  "detectSingleReplicate",
  "NormalyzerDataset",
...
#' @keywords internal
setGeneric(name = "detectSingletonSample", function(nds, quiet) {
  standardGeneric("detectSingletonSample")
})

#' @rdname detectSingletonSample
setMethod(
  "detectSingletonSample",
  "NormalyzerDataset",
  function(nds, quiet = FALSE) {
...
setGeneric(name = "checkSingleReplicateRun", function(nds, quiet) {
  standardGeneric("checkSingleReplicateRun")
})
setMethod(
  "checkSingleReplicateRun",
  "NormalyzerDataset",
  function(nds, quiet = FALSE) {
