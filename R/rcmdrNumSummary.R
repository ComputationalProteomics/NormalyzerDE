# This code is extracted from the package RcmdrMisc to omit the graphical TK dependency
# It is licensed under a GPL3 license

rcmdrNumSummary <- function (data, 
          statistics = c("mean", "sd", "se(mean)", "IQR", "quantiles", "cv", "skewness", "kurtosis"), 
          type = c("2", "1", "3"), 
          quantiles = c(0, 0.25, 0.5, 0.75, 1), groups) {
